...
import { loader as InitiateViewLoader } from "@/routes/loader+/feature+/source+/view-initiate";
import { action as SendEmailsAction } from "@/routes/action+/feature+/source+/intitiate-send-emails.action";
